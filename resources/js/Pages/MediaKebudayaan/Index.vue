...
const deleteMateri = (id) => {
    if (confirm('Apakah Anda yakin ingin menghapus media kebudayaan ini?')) {
        router.delete(`/media-kebudayaan/${id}`);
    }
};
...
<template>
    <Head title="Media Kebudayaan" />

    <AdminLayout>
        <template #title>Manajemen Media Kebudayaan</template>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
                        Kelola media dan konten kebudayaan
                    </p>
                </div>
                <Link v-if="can('create materi kebudayaan')" href="/media-kebudayaan/create"
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-purple-800 dark:text-purple-300 leading-relaxed">
                            Media kebudayaan yang Anda kelola akan ditampilkan di halaman kebudayaan pada <a href="https://kebudayaan.wikimedia.or.id/kebudayaan" target="_blank"
                                class="font-semibold underline hover:text-purple-600 dark:hover:text-purple-200 transition-colors">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                <h3 class="text-lg font-semibold text-slate-800 dark:text-white">Daftar Media Kebudayaan</h3>
            </div>
            ...
            <div class="overflow-x-auto">
                        ...
                        <tr v-for="item in materi" :key="item.id"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <Link v-if="can('view materi kebudayaan')" :href="`/media-kebudayaan/${item.id}`"
                                    ...
                                    <Link v-if="can('edit materi kebudayaan')" :href="`/media-kebudayaan/${item.id}/edit`"
                                    ...
                                    <button v-if="can('delete materi kebudayaan')" @click="deleteMateri(item.id)"
                ...
                <div v-if="materi.length === 0" class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-slate-900 dark:text-white mb-2">
                        Belum ada media kebudayaan
                    </h3>
                    <p class="text-slate-500 dark:text-slate-400 mb-6">
                        Mulai menambahkan media kebudayaan untuk ditampilkan
                    </p>
                    <Link href="/media-kebudayaan/create"
