    ...
    <AdminLayout>
        ...
        <div class="mb-6 md:mb-8">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-slate-900 dark:text-white font-medium">Detail Pesan</span>
            </nav>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700"
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-white/80 mt-1">Portal {{ submission.website_source }}</p>
                            </div>
                    ...
                    <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <p class="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Nama Pengirim</p>
                            ...
                            <div>
                                <p class="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Nomor HP</p>
                    ...
                    <!-- Message Content -->
                    <div class="px-6 py-6">
                        <h4 class="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Isi Pesan</h4>
                    ...
                    <div class="px-6 py-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                        <div class="flex items-center justify-between text-sm text-slate-500 dark:text-slate-400">
                            <span>Diterima pada: {{ new Date(submission.created_at).toLocaleString('id-ID', {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric',
                                hour: '2-digit',
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                        <h3 class="text-lg font-semibold text-slate-800 dark:text-white">Status Pesan</h3>
                    </div>
