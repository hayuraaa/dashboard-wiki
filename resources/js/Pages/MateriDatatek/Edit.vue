...
const form = useForm({
    ...
    keterangan: props.materi.keterangan,
    jenis_media: props.materi.jenis_media,
    url_media: props.materi.url_media,
    is_active: props.materi.is_active,
    urutan: props.materi.urutan,
});
...
const submit = () => {
    form.put(`/materi-datatek/${props.materi.id}`);
};
</script>
...
<template>
    ...
    <AdminLayout>
        <template #title>Edit Materi</template>
        ...
        <div class="mb-6 md:mb-8">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-slate-900 dark:text-white font-medium">Edit Materi</span>
            </nav>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-800 dark:text-white">Edit Informasi Materi</h3>
                        <p class="text-sm text-slate-600 dark:text-slate-400">Perbarui data materi pembelajaran</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="p-6 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-6 border-t border-slate-200 dark:border-slate-700 gap-3">
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        <span v-else>Update Materi</span>
                    </button>
                </div>
            </form>
        </div>
